defmodule LiftiexWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: LiftiexWeb.Gettext
  ...
  defp error(assigns) do
    ...
    <p class="mt-1.5 flex gap-2 items-center text-sm text-error">
      <.icon name="lucide-exclamation-circle" class="size-5" />
      {render_slot(@inner_block)}
    </p>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiftiexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiftiexWeb.Gettext, "errors", msg, opts)
    end
  end
